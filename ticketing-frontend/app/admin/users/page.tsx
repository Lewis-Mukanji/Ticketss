...
export default function AdminDashboard() {
  ...
  const recentUsers = [
    { id: 1, name: "John Doe", email: "john@example.com", tickets: 2, totalSpent: 10000 },
    { id: 2, name: "Jane Smith", email: "jane@example.com", tickets: 3, totalSpent: 15000 },
    { id: 3, name: "Mike Johnson", email: "mike@example.com", tickets: 1, totalSpent: 5000 },
  ];
